  ...
  <div class="row animated fadeInRight">
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <input type="hidden" id="xuqiu_id" value="${xuqiu.id}"/>

        <div class="ibox-content timeline" id="xiaoxi_body">
...
<script>
    var xuqiuid = $("#xuqiu_id").val();
    $(document).ready(function(){
        queryXiaoxi();
    });
    function queryXiaoxi() {
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/xuqiu/queryXiaoxi",       //         &pageNumber=xx &name=xx &caid=xx
            data:"xuqiuid="+xuqiuid,
            dataType:"json",
            success:function(msg){
                //$("#checkall").prop("checked",false);
                console.log(msg);
                var tr ="";
                $.each(msg.data,function(i,xiaoxi){
                    tr+="<div class='timeline-item'> <div class='row'> <div class='col-xs-3 date' <i class='fa fa-comments'></i>"+xiaoxi.time
                    +"<br> <small class='text-navy'></small> </div> <div class='col-xs-7 content'> <p class='m-b-xs'>"+xiaoxi.title
                    +"<strong></strong></p><p>"+xiaoxi.content+"</p></div></div></div>";
                });
                $("#xiaoxi_body").html(tr);
            }
