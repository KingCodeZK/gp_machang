...
//                });
    ...
    function query(page,rows,name){
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/xuqiu/query_xq",       //         &pageNumber=xx &name=xx &caid=xx
